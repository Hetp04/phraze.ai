...
var __PRIVATE_IndexBackfiller = class {
  ...
  re(e, t) {
    ...
    return PersistencePromise.doWhile(() => true === i && r > 0, () => this.localStore.indexManager.getNextCollectionGroupToUpdate(e).next((t2) => {
      if (null !== t2 && !n.has(t2))
        return __PRIVATE_logDebug(q, `Processing collection: ${t2}`), this.ie(e, t2, r).next((e2) => {
          r -= e2, n.add(t2);
        });
      i = false;
    })).next(() => t - r);
  ...
  switch (n) {
    ...
    case 11:
      return function __PRIVATE_compareMaps(e2, t2) {
        if (e2 === ot.mapValue && t2 === ot.mapValue)
          return 0;
        if (e2 === ot.mapValue)
          return 1;
        if (t2 === ot.mapValue)
...
function __PRIVATE_queryNormalizedOrderBy(e) {
  ...
  if (null === t.he) {
    ...
    for (const n2 of t.explicitOrderBy)
      t.he.push(n2), e2.add(n2.field.canonicalString());
...
var __PRIVATE_WatchChangeAggregator = class {
  ...
  We(e) {
    for (const t of e.me)
      e.fe && e.fe.isFoundDocument() ? this.Ge(t, e.fe) : this.ze(t, e.key, e.fe);
    for (const t of e.removedTargetIds)
      this.ze(t, e.key, e.fe);
  }
...
function __PRIVATE_fromDbRemoteDocument(e, t) {
  let n;
  if (t.document)
    n = __PRIVATE_fromDocument(e.Tt, t.document, !!t.hasCommittedMutations);
...
var __PRIVATE_FirestoreIndexValueWriter = class {
  ...
  Rt(e, t) {
    if ("nullValue" in e)
      ...
      this.ft(t, 15), t.gt(__PRIVATE_normalizeNumber(e.integerValue));
      ...
      this.wt(e.stringValue, t), this.bt(t);
    else if ("bytesValue" in e)
      this.ft(t, 30), t.St(__PRIVATE_normalizeByteString(e.bytesValue)), this.bt(t);
    else if ("referenceValue" in e)
      this.Dt(e.referenceValue, t);
    else if ("geoPointValue" in e) {
      const n = e.geoPointValue;
      this.ft(t, 45), t.gt(n.latitude || 0), t.gt(n.longitude || 0);
    } else
      "mapValue" in e ? __PRIVATE_isMaxValue(e) ? this.ft(t, Number.MAX_SAFE_INTEGER) : __PRIVATE_isVectorValue(e) ? this.vt(e.mapValue, t) : (this.Ct(e.mapValue, t), this.bt(t)) : "arrayValue" in e ? (this.Ft(e.arrayValue, t), this.bt(t)) : fail();
  }
  wt(e, t) {
  ...
  un(e) {
    ...
    if (this.rn.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.ln(e2, t2) || !this.hn(this.sn[s++], t2))
          return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.sn.length || !this.hn(this.sn[s++], e2))
        return false;
    }
    return true;
  }
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  Vn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r)
        if (this.bn(t, s.fieldPath) && isArray(e2))
          r = this.Sn(r, s, e2);
        else {
    ...
    if (null != i) {
      ...
      if (isArray(s))
        for (const i2 of s.arrayValue.values || [])
          n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.fn(i2), r));
    } else
      n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, yt, r));
    return n;
  }
  /**
...
var __PRIVATE_MemoryMutationQueue = class {
  ...
  addMutationBatch(e, t, n, r) {
    ...
    for (const t2 of r)
      this.Mr = this.Mr.add(new __PRIVATE_DocReference(t2.key, i)), this.indexManager.addToCollectionParentIndex(e, t2.key.path.popLast());
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    ...
    this.fi = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.D())
  ...
  async Li() {
    if (this.isPrimary && !this.ki(this.mi, Ct)) {
      ...
      if (this.yi)
        for (const t of e)
          this.yi.removeItem(this.Qi(t.clientId));
    }
  }
  /**
  ...
  Mi(e) {
    ...
    return __PRIVATE_primaryClientStore(e).get(W).next((t) => {
      if (null !== t && this.ki(t.leaseTimestampMs, Ft) && !this.$i(t.ownerId)) {
        if (this.Ni(t) && this.networkEnabled)
          return true;
        if (!this.Ni(t)) {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    return this.rs(e, t).next((e2) => {
      ...
      return this._s(e, t, n2).next((r2) => {
        if (i.result = r2, this.Xi)
          return this.us(e, t, n2, r2.size);
      });
    }).next(() => i.result);
  }
  us(e, t, n, r) {
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      ...
      if (t2)
        return i = t2.lastLimboFreeSnapshotVersion, r.Hr.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
          s = e3;
        });
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0)
      return i.Yr.saveNamedQuery(e2, t);
...
var __PRIVATE_WebStorageSharedClientState = class {
  ...
  Ms(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(qt, "EVENT", t.key, t.newValue), t.key === this.Ns)
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          __PRIVATE_logDebug(Wt, `RPC '${e}' stream ${r} received:`, i2), P.Uo(i2);
      }
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.H_.We(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.H_.Ze(t) : e.H_.je(t), !n.isEqual(SnapshotVersion.min()))
    try {
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1)
    return r.qa.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.ka.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r of e.qa.get(t))
    e.ka.delete(r), n && e.La.Ja(r, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      e.Ua.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
...
var FirestoreSettingsImpl = class {
  constructor(e) {
    ...
    if (void 0 === e.host) {
      ...
      this.host = e.host, this.ssl = null !== (t = e.ssl) && void 0 !== t ? t : en;
...
function initializeFirestore(e, t, n) {
  ...
  if (void 0 !== t.cacheSizeBytes && -1 !== t.cacheSizeBytes && t.cacheSizeBytes < Dt)
    throw new FirestoreError(C.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
  return r.initialize({
    options: t,
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.Lu))
        throw t2.Wu(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.Wu(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.Wu(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
            ...
            [at]: {
              arrayValue: {
                values: e3.toArray().map((e4) => {
                  if ("number" != typeof e4)
                    throw t3.Wu("VectorValues must only contain numeric values.");
